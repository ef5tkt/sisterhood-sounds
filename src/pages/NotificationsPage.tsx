  ...
  comments: [
    {
      id: "c1",
      user: "月光姐姐",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=moon&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "评论了你的作品",
      target: "晚安冥想 #001",
    ...
    },
    {
      id: "c2",
      user: "诗意人生",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=poetry&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "评论了你的作品",
      target: "海子的诗",
      content: "声音好温柔，朗诵得真好",
      time: "15分钟前",
    },
    {
      id: "c3",
      user: "咖啡与书",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=coffee&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "评论了你的作品",
      target: "雨天的咖啡馆",
      content: "故事好有画面感！",
      time: "1小时前",
    },
    {
      id: "c4",
      user: "瑜伽小姐姐",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=yoga&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "回复了你的评论",
      target: "清晨唤醒冥想",
      content: "谢谢姐妹的支持 ❤️",
      time: "3小时前",
  ...
  likes: [
    {
      id: "l1",
      user: "温柔说书人",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=book&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "赞了你的作品",
      target: "写给18岁的自己",
      time: "刚刚",
    },
    {
      id: "l2",
      user: "职场姐姐",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=career&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "赞了你的作品",
      target: "晚安冥想 #001",
      time: "5分钟前",
    },
    {
      id: "l3",
      user: "暖心妈妈",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=mama&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "赞了你的作品",
      target: "林徽因 · 四月天",
      time: "20分钟前",
    },
    {
      id: "l4",
      user: "古典之声",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=classic&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "赞了你的作品",
      target: "海子的诗",
      time: "1小时前",
    },
    {
      id: "l5",
      user: "星空女孩",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=star&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "赞了你的作品",
      target: "清晨唤醒冥想",
      time: "2小时前",
    },
  ...
  collects: [
    {
      id: "s1",
      user: "梦想家",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=dream&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "收藏了你的作品",
      target: "晚安冥想 #001",
      time: "10分钟前",
    },
    {
      id: "s2",
      user: "夜猫子",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=night&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "收藏了你的作品",
      target: "写给18岁的自己",
      time: "30分钟前",
    },
    {
      id: "s3",
      user: "文艺青年",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=art&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      action: "收藏了你的作品",
      target: "海子的诗",
      time: "2小时前",
    },
