...
const mockComments: Comment[] = [
  {
    ...
    author: "温暖的阳光",
    authorId: "user_sun",
    avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=sun&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
  ...
  },
  {
    ...
    author: "清风徐来",
    authorId: "user_wind",
    avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=wind&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
  ...
  },
  {
    ...
    avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=flower&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
...
const AudioDetailModal = ({ isOpen, onClose, audio }: AudioDetailModalProps) => {
  ...
  const handleSendComment = () => {
    ...
    const comment: Comment = {
      ...
      author: "我",
      authorId: "myprofile",
      avatar: "https://api.dicebear.com/7.x/notionists/svg?seed=user&backgroundColor=fff0f5,f0f4ff,f5fff0&backgroundType=gradientLinear",
      content: newComment,
      time: "刚刚",
      likes: 0,
    };
